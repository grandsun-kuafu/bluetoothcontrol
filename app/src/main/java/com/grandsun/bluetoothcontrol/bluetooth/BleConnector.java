                ...
                switch (msg.what) {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_START: {
                        ...
                        if (notifyCallback != null)
                            notifyCallback.onNotifyFailure(new OtherException("time out"));
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_RESULT: {
                        ...
                        if (notifyCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                ...
                                notifyCallback.onNotifyFailure(new OtherException("MSG_CHA_NOTIFY_RESULT notify fail"));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_INDICATE_START: {
                        ...
                        if (indicateCallback != null)
                            indicateCallback.onIndicateFailure(new OtherException("time out"));
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_INDICATE_RESULT: {
                        ...
                        if (indicateCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                ...
                                indicateCallback.onIndicateFailure(new OtherException("MSG_CHA_INDICATE_RESULT indicate fail"));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_WRITE_START: {
                        ...
                        if (writeCallback != null) {
                            writeCallback.onWriteFailure(new OtherException("time out"));
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_WRITE_RESULT: {
                        ...
                        if (writeCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                ...
                                writeCallback.onWriteFailure(new OtherException("MSG_CHA_WRITE_RESULT write fail"));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_READ_START: {
                        ...
                        if (readCallback != null)
                            readCallback.onReadFailure(new OtherException("time out"));
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_READ_RESULT: {
                        ...
                        if (readCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                ...
                                readCallback.onReadFailure(new OtherException(""));
                            }
                        }
                        break;
                    }
                    ...
                    case BleMsg.MSG_READ_RSSI_START: {
                        ...
                        if (rssiCallback != null)
                            rssiCallback.onRssiFailure(new OtherException(""));
                        break;
                    }
                    ...
                    case BleMsg.MSG_SET_MTU_START: {
                        ...
                        if (mtuChangedCallback != null)
                            mtuChangedCallback.onSetMTUFailure(new OtherException(""));
                        break;
                    }
